...
var QPDiffTester = (() => {
  ...
  return (
    function (config) {
      var QPDiffTester = config || {};

      var Module = typeof QPDiffTester != "undefined" ? QPDiffTester : {};
      ...
      ["_main", "_greet", "_diffPostgresQueryPlans", "_diffPrestoQueryPlans", "_add", "_malloc", "_free", "_fflush", "onRuntimeInitialized"].forEach(prop => {
      ...
      assert(INITIAL_MEMORY == 65536e3, "Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically");
      ...
      var _diffPostgresQueryPlans = Module["_diffPostgresQueryPlans"] = createExportWrapper("diffPostgresQueryPlans");

      var _malloc = Module["_malloc"] = createExportWrapper("malloc");

      var _greet = Module["_greet"] = createExportWrapper("greet");

      var _diffPrestoQueryPlans = Module["_diffPrestoQueryPlans"] = createExportWrapper("diffPrestoQueryPlans");
      ...
      return QPDiffTester.ready
    }
  );
})();
export default QPDiffTester;